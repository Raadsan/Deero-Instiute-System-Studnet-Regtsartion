...
"[project]/components/modules/finance-users-list.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FinanceUsersList() {
    ...
    const fetchUsers = async ()=>{
        ...
        setError(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/api/finance-users?includeInactive=true");
            setUsers(res.data);
        } catch (e) {
    ...
    const activeCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>users.filter((user)=>user.isActive).length, [
        users
    ]);
    const submit = async ()=>{
        ...
        try {
            ...
            if (editing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].patch(`/api/finance-users/${editing.id}`, payload);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])({
                    title: "Finance user updated successfully"
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/api/finance-users", {
                    ...payload,
    ...
    const confirmDelete = async ()=>{
        ...
        setDeleting(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/api/finance-users/${deleteId}`);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])({
    ...
    const toggleStatus = async (user)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].patch(`/api/finance-users/${user.id}`, {
                name: user.name,
                email: user.email,
                isActive: nextIsActive
            });
...
//# sourceMappingURL=_a9a6c0bf._.js.map