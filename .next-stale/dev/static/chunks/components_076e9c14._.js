...
"[project]/components/dashboard/dashboard-metrics.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DashboardMetrics() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardMetrics.useEffect": ()=>{
            const run = {
                "DashboardMetrics.useEffect.run": async ()=>{
                    setLoading(true);
                    setError(null);
                    try {
                        const summaryRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/api/reports/summary");
            ...
            }["DashboardMetrics.useEffect.run"];
            void run();
        }
    }["DashboardMetrics.useEffect"], []);
    const metrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardMetrics.useMemo[metrics]": ()=>{
    ...
    const enrollmentData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardMetrics.useMemo[enrollmentData]": ()=>(summary?.enrollmentTrends ?? []).map({
                "DashboardMetrics.useMemo[enrollmentData]": (p)=>({
                        month: p.label,
                        students: p.value
                    })
            }["DashboardMetrics.useMemo[enrollmentData]"])
    }["DashboardMetrics.useMemo[enrollmentData]"], [
        summary
    ]);
    const attendanceData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardMetrics.useMemo[attendanceData]": ()=>(summary?.weeklyAttendance ?? []).map({
                "DashboardMetrics.useMemo[attendanceData]": (p)=>({
                        day: p.label,
                        present: p.present,
                        absent: p.absent
                    })
            }["DashboardMetrics.useMemo[attendanceData]"])
    }["DashboardMetrics.useMemo[attendanceData]"], [
        summary
    ]);
    const paymentData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardMetrics.useMemo[paymentData]": ()=>{
    ...
    const classSizeData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardMetrics.useMemo[classSizeData]": ()=>(summary?.largestClasses ?? []).map({
                "DashboardMetrics.useMemo[classSizeData]": (c)=>({
                        name: c.name,
                        students: c.students
                    })
            }["DashboardMetrics.useMemo[classSizeData]"])
    }["DashboardMetrics.useMemo[classSizeData]"], [
        summary
    ]);
    const absenceData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardMetrics.useMemo[absenceData]": ()=>(summary?.highestAbsenceClasses ?? []).map({
                "DashboardMetrics.useMemo[absenceData]": (c)=>({
                        name: c.name,
                        rate: c.rate
                    })
            }["DashboardMetrics.useMemo[absenceData]"])
    }["DashboardMetrics.useMemo[absenceData]"], [
        summary
    ]);
            ...
            !loading && !error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChartCard, {
                        ...
                        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$calendar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Calendar$3e$__["Calendar"],
                        children: attendanceData.every((d)=>d.present === 0 && d.absent === 0) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EmptyChart, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChartCard, {
                                ...
                                children: classSizeData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EmptyChart, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChartCard, {
                                ...
                                children: absenceData.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EmptyChart, {
...
_s(DashboardMetrics, "VWLgomUMvnY0+FuYL7z+M5Sl1DU=");
_c2 = DashboardMetrics;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "ChartCard");
__turbopack_context__.k.register(_c1, "EmptyChart");
__turbopack_context__.k.register(_c2, "DashboardMetrics");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=components_076e9c14._.js.map